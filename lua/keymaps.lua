...
vim.keymap.set('n', 'zt', function()
  ...
  vim.lsp.enable('typos_lsp', vim.wo.spell)
...
vim.api.nvim_create_user_command('AnsiColorize', ansi_colorize, { desc = 'Render the current buffer inside a terminal with ANSI colors' })
